...
module.exports = function (db, module) {
	...
	module.setAdd = function (key, value, callback) {
		...
		util.callbackify(() => db.collection('objects').updateOne({
			_key: key
		}, {
			$addToSet: {
				members: {
	...
	module.setsAdd = function (keys, value, callback) {
		...
		util.callbackify(() => bulk.execute())(function (err, res) {
			callback(err);
		});
	};
	...
	module.setRemove = function (key, value, callback) {
		...
		util.callbackify(() => db.collection('objects').updateOne({_key: key}, {$pullAll: {members: value}}))(function (err, res) {
			callback(err);
		});
	};
	...
	module.setsRemove = function (keys, value, callback) {
		...
		for(var i = 0; i < keys.length; ++i) {
			bulk.find({_key: keys[i]}).updateMany({$pull: {
				members: value
			}});
		}
	...
	module.isSetMember = function (key, value, callback) {
		...
		util.callbackify(() => db.collection('objects').findOne({_key: key, members: value}, {_id: 0, members: 0}))(function (err, item) {
	...
	module.isSetMembers = function (key, values, callback) {
		...
		util.callbackify(() => db.collection('objects').findOne({_key: key}, {_id: 0, _key: 0}))(function (err, items) {
			if (err) {
				return callback(err);
			}
	...
	module.isMemberOfSets = function (sets, value, callback) {
		...
		util.callbackify(() => db.collection('objects').find({_key: {$in : sets}, members: value}, {_id:0, members: 0}).toArray())(function (err, result) {
			if (err) {
				return callback(err);
			}
	...
	module.getSetMembers = function (key, callback) {
		...
		util.callbackify(() => db.collection('objects').findOne({_key: key}, {members: 1}, {_id: 0, _key: 0}))(function (err, data) {
	...
	module.getSetsMembers = function (keys, callback) {
		...
		util.callbackify(() => db.collection('objects').find({_key: {$in: keys}}, {_id: 0, _key: 1, members: 1}).toArray())(function (err, data) {
			if (err) {
				return callback(err);
			}
	...
	module.setCount = function (key, callback) {
		...
		util.callbackify(() => db.collection('objects').findOne({_key: key}, {_id: 0}))(function (err, data) {
	...
	module.setRemoveRandom = function (key, callback) {
		...
		util.callbackify(() => db.collection('objects').findOne({_key:key}))(function (err, data) {
			if(err || !data) {
				return callback(err);
			}
